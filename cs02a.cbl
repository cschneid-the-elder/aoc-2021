      ...
      *
       ...
       Procedure Division.
           ...
           PERFORM UNTIL INPT-DATA-EOF
             EVALUATE TRUE
               WHEN OPERATION-FORWARD ADD OPERATION-ARG TO CURR-HPOSN
               WHEN OPERATION-DOWN    ADD OPERATION-ARG TO CURR-DEPTH
               WHEN OPERATION-UP SUBTRACT OPERATION-ARG FROM CURR-DEPTH
               WHEN OTHER
                          DISPLAY
